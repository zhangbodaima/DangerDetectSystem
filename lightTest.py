...
#     net.to(device)
#     net.eval()
#     net.load_state_dict(torch.load("lightWeight.pth"),map_location=torch.device('cpu'))
...
#     net.to(device)
#     net.eval()
#     net.load_state_dict(torch.load("lightWeight_res.pth"),map_location=torch.device('cpu'))
#     img_tensor=process_transform(img)
#     img_tensor.unsqueeze_(0)
#     img_tensor=img_tensor.to(device)
#     out=net(img_tensor)
